...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { contato: @agenda.contato, data: @agenda.data, endereco: @agenda.endereco, hora: @agenda.hora, responsavel: @agenda.responsavel }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { contato: @agenda.contato, data: @agenda.data, endereco: @agenda.endereco, hora: @agenda.hora, responsavel: @agenda.responsavel }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
