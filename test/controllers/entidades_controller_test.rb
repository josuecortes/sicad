...
class EntidadesControllerTest < ActionController::TestCase
  ...
  test "should create entidade" do
    assert_difference('Entidade.count') do
      post :create, entidade: { codigo: @entidade.codigo, data_criacao: @entidade.data_criacao, nome: @entidade.nome }
    end
  ...
  test "should update entidade" do
    patch :update, id: @entidade, entidade: { codigo: @entidade.codigo, data_criacao: @entidade.data_criacao, nome: @entidade.nome }
    assert_redirected_to entidade_path(assigns(:entidade))
  end
