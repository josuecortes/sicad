...
class VeiculosControllerTest < ActionController::TestCase
  ...
  test "should create veiculo" do
    assert_difference('Veiculo.count') do
      post :create, veiculo: { contato: @veiculo.contato, placa: @veiculo.placa, proprietario: @veiculo.proprietario, tipo: @veiculo.tipo }
    end
  ...
  test "should update veiculo" do
    patch :update, id: @veiculo, veiculo: { contato: @veiculo.contato, placa: @veiculo.placa, proprietario: @veiculo.proprietario, tipo: @veiculo.tipo }
    assert_redirected_to veiculo_path(assigns(:veiculo))
  end
