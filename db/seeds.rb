...
master = User.create(email: sicad.ap@gmail.com,:password=>"@#sicad$%",:password_confirmation=>"@#sicad$%",:tipo=>"MASTER",:name=>"ADMINISTRADOR SICAD")
...
usuario_teste_administrador = User.create(:name=>"TESTE ADMIN",:tipo=>"ADMINISTRADOR",:password=>"teste123",:password_confirmation=>"teste123",:email=>"teste@sicad.xyz",:entidade=>entidade_teste)
